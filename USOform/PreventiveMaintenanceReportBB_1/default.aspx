    ...
    <form id="form1" runat="server">
        ...
        <div class="container bg-white Myfont mt-3">
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="dcTextbox" runat="server">
                </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="loaddcTextbox" runat="server">
                </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="RectifierTextbox" runat="server">
                </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryVoltagetextbox" runat="server">
                </div>
                <label class="control-label col-sm-2" for="">V.</label>
            </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryTempTexbox" runat="server">
                </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryVoltagetextbox1" runat="server">
                </div>
                <label class="control-label col-sm-2" for="">V.</label>
            </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryVoltagetextbox2" runat="server">
                </div>
                <label class="control-label col-sm-2" for="">V.</label>
            </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryVoltagetextbox3" runat="server">
                </div>
                <label class="control-label col-sm-2" for="">V.</label>
            </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryVoltagetextbox4" runat="server">
                </div>
                <label class="control-label col-sm-2" for="">V.</label>
            </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="BatteryCapacitytextbox" runat="server">
                </div>
            ...
            <div class="form-row mt-3">
                ...
                <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="brokenElecRadio" value="ไม่พบไฟฟ้ารั่ว" <% if (answers.Count() > 0 && answers.Where(x => x.QuestionId == 1284).FirstOrDefault().AnsDes == "ไม่พบไฟฟ้ารั่") { Response.Write("checked"); } else { Response.Write(""); } %> />ไม่พบไฟฟ้ารั่ว
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="brokenElecRadio" value="แว" <% if (answers.Count() > 0 && answers.Where(x => x.QuestionId == 1284).FirstOrDefault().AnsDes == "ไม่พบไฟฟ้ารั่") { Response.Write("checked"); } else { Response.Write(""); } %> />พบไฟฟ้ารั่ว
                    </label>
                </div>
            </div>
            <%--////////////// ------------------------------  //////////////////--%>
